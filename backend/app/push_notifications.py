...
def _send_push(subscription: PushSubscription, title: str, body: str, url: str = "/workout.html") -> tuple[bool, str]:
    """
    Send a Web Push notification using pywebpush + py_vapid.
    Returns (True, "") on success, (False, reason) on failure.

    Key format: VAPID_PRIVATE_KEY must be the raw base64url-encoded
    EC private key (32 bytes), as generated by `py_vapid --gen` or
    ...
    try:
        ...
        return False, f"Missing dependency: {e}. Add pywebpush and py_vapid to requirements.txt"
