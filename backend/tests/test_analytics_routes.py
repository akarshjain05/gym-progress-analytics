def test_analytics_compare(client, auth_headers):
    headers = auth_headers(client, "analytics_u1", "password123")
...
def test_analytics_wrapped(client, auth_headers):
    headers = auth_headers(client, "analytics_u2", "password123")
...
def test_analytics_strength_percentiles(client, auth_headers):
    headers = auth_headers(client, "analytics_u3", "password123")
