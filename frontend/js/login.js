...
loginForm.addEventListener("submit", async (e) => {
  ...
  try {
    ...
    if (err.message && err.message.toLowerCase().includes("verify your email")) {
      alertSlot.innerHTML = DOMPurify.sanitize(`<div class="alert alert-error">${escapeHtml(err.message)} <br><a href="#" id="resendVerificationLink" style="font-weight:600;margin-top:8px;display:inline-block;">Resend verification email</a></div>`);
